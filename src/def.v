...
function length3 (input [7:0] i);
    length3 = anl_di_da(i)|orl_di_da(i)|xrl_di_da(i)|
              mov_di_di(i)|mov_di_da(i)|mov_dp_da(i)|
              jb(i)|jnb(i)|jbc(i)|acall(i)|lcall(i)|ret(i)|reti(i)|ljmp(i)|cjne_a_di(i)|cjne_a_da(i)|cjne_rn_da(i)|cjne_ri_da(i)|djnz_di(i);
endfunction
